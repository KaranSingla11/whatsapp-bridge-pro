...
app.get('/embed/chat-widget.js', (req, res) => {
    ...
    if (fs.existsSync(widgetPath)) {
        ...
        // Inline widget code as fallback (simple version)
        widgetCode = '(function() { var s=document.createElement("script"); s.src="https://cdn.jsdelivr.net/npm/whatsapp-web.js@1.0.0/dist/web.js"; document.body.appendChild(s); console.log("WhatsApp Bridge Chat Widget - Inline Fallback Active"); })();';
    }
